            ...
            <div className="tw-container tw-mx-auto">
                ...
                <main>
                    <section className="tw-text-center tw-mb-3.5">
                        <p className="tw-text-6xl tw-font-bold tw-text-gray-900 tw-w-full sm:tw-w-1/2 tw-mx-auto tw-text-center">Your notes application with a <span className="tw-text-blue-600">boost&nbsp;<FontAwesomeIcon icon={faRocket}/></span></p>
                        <p className="tw-text-base tw-text-gray-900 tw-full sm:tw-w-1/2 tw-mx-auto tw-text-center"><span className=""><span className="tw-text-blue-600 tw-font-black">Cordum</span> is a note application that brings the power of a document to you. Take notes, store them online and access them from anywhere.</span></p>
                    ...
                    <section className={`${HomeStyles.gkc__section}`}>
                        <div className={HomeStyles.gkc__ImageContainer}><img src={applicationView} alt="applicationView"/></div>
                        <div>
                            <p className="tw-font-medium tw-text-3xl">01. Start taking notes in rich-text format.</p>
                            <p className="tw-text-base">Want to take your notes in a format that's easy to read? <span className="tw-text-blue-600">Cordum</span> makes it easy to do that.</p>
                    ...
                    <section className={`${HomeStyles.gkc__section} tw-my-12`}>
                        <div>
                            <p className="tw-font-medium tw-text-3xl">02. Get past cluttered notes.</p>
                            <p className="tw-text-base"> De-clutter your notes by organizing them. Whether it's a shopping list or lecture note or a random idea or maybe you wan't to quickly summarize a document, <span className="tw-text-blue-600">Cordum</span> helps you do it all.</p>
                            <Link to={user !== null ? '/overview': '/register'} className="tw-text-blue-600 tw-no-underline">Get Started <FontAwesomeIcon icon={faArrowRight}/></Link>
                        </div>
                        <div className={HomeStyles.gkc__ImageContainer}><img src={labelView} alt="labelView"/></div>
                    </section>
                </main>
            </div>
            <section className="tw-bg-blue-600 tw-py-16 tw-text-center">
                <p className="tw-text-white tw-font-bold tw-text-4xl">Start using Cordum now.</p>
